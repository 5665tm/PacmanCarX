...
public class JSONObject
{
	...
	public static JSONObject nullJO { get { return new JSONObject(Type.NULL); } } //an empty, null object
	public static JSONObject obj { get { return new JSONObject(Type.OBJECT); } } //an empty object
	public static JSONObject arr { get { return new JSONObject(Type.ARRAY); } } //an empty array
	...
	{
		return new JSONObject {type = Type.STRING, str = val};
	}
